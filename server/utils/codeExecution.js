...
//POST URL
const postUrl =
  "http://ec2-34-227-73-43.compute-1.amazonaws.com/submissions/batch?base64_encoded=true";
...
const createUrl = (responseTokens) => {
  ...
  const url =
    "http://ec2-34-227-73-43.compute-1.amazonaws.com/submissions/batch?tokens=" +
    tokens.slice(1) +
    "&base64_encoded=false&fields=token,stdout,stderr,status_id,language_id";
  return url;
};
